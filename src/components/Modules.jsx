...
const modules = [
  ...
  { id: 'M02', name: 'Mandi Price Predictor',        domain: 'Agriculture',    route: null,           desc: '14-day price forecast for 3,000 mandis. Eliminates information asymmetry between farmers and traders.',            model: 'LSTM Time-Series',           impact: '₹15K–25K/season saved' },
